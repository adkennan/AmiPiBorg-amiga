...
typedef VOID(*EventHandler)(APTR, struct EventNode *);
...
VOID APB_DestroyEventBroker(EventBroker eb);

ULONG APB_AddSubscriber(EventBroker eb, UWORD eventTypes, APTR obj, EventHandler handler);

VOID APB_RemoveSubscriber(EventBroker eb, ULONG handle);

BOOL APB_EmitEvent(EventBroker eb, UWORD eventType, BYTE *data, UWORD length); 
